"""
BB Ï?§Ì?¥Ï¶? + Î∞¥Î?? Îè?Ì?? + RSI + ATR SL Î¥?.
Ì??Í≤ΩÎ≥?Ï??(.env) Î?êÎ?? systemd EnvironmentFile.
"""
...
# Risk / execution (Ï?§Ì?? Ïù¥Î¶? + Ì??Ï?? Ì?∏Ì??)
...
# Ì?∏Î†?Ïùº Ì??Ï?±Ì??: Îß?ÌÅ¨Í∞? Ïß?Ï??Í∞? ¬± signal_atr √? Ïù¥ Î∞∞Ï?? Îè?Î?¨ Ï?? 15Î∂?Î¥? Ì?∏Î†?Ïùº Ï??Ï??
TRAIL_ACTIVATE_MULTIPLIER = _get_env_float("TRAIL_ACTIVATE_MULTIPLIER", 0.5)
# Ì?∏Î†?Ïùº ÎØ∏Ì??Ï?± Ï±?Î°? NÍ∞? 15Î∂? Ì??Ï†?Î¥?Ïù¥ Ïß?Î??Î©¥ Î≥∏Ï†? Ï≤≠Ï?∞(Ï??Ï?•Í∞?)
TIME_EXIT_BARS = _get_env_int("TIME_EXIT_BARS", 4)

# Í≥†Î≥?Îè?Ï?±: SLÍ±∞Î¶¨ (MAX_SL_PCT, HIGH_VOL_MAX_SL_PCT] Íµ¨Í∞?Ïù? Ï??Ï?° Ïß?Ï??
...
MAX_TICK_PCT_FOR_ENTRY = _get_env_float("MAX_TICK_PCT_FOR_ENTRY", 0.004)
